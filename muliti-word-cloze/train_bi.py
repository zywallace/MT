...
from decoder import cloze_decode
...
def main(options):
    ...
    batched_train, batched_train_mask, _ = utils.tensor.advanced_batchize(train, options.batch_size,
                                                                          vocab.stoi["<pad>"])
    ...
    for epoch_i in range(options.epochs):
        ...
        for i, batch_i in enumerate(utils.rand.srange(len(batched_train))):
            ...
            sys_out_batch = rnnlm(
                train_batch)  # (seq_len, batch_size, vocab_size) # TODO: substitute this with your module
